...
export const DisconnectBanner: React.FC<DisconnectBannerProps> = ({ telemetry }) => {
  ...
  return (
    <div className="w-full bg-red-600 text-white px-4 py-1.5 flex items-center justify-between text-xs font-bold tracking-wide uppercase shadow-lg z-50 animate-pulse-fast select-none">
