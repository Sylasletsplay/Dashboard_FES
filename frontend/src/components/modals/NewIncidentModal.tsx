      ...
      <div className="bg-slate-900 border border-slate-700 rounded-lg max-w-md w-full p-5 shadow-2xl text-slate-100 select-text">
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-sm tracking-wide uppercase">Neue Einsatzstelle erfassen</h3>
          </div>
          <button 
            type="button" 
            onClick={onClose} 
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100 text-sm focus:border-red-500 focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-700 rounded px-2 py-1 text-slate-100 font-mono text-xs focus:border-red-500 focus:outline-none"
              />
            </div>
            <div>
