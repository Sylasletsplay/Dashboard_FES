...
export const UnitMatrixWidget: React.FC<UnitMatrixWidgetProps> = ({ state, sendEvent, onOpenNewUnit }) => {
  ...
  const getStatusButtonClass = (buttonStatus: FMSStatus, currentStatus: FMSStatus) => {
    ...
    const base = 'w-5 h-5 rounded text-[10px] font-mono font-bold flex items-center justify-center transition-all ';
  ...
  return (
    <div className="h-full flex flex-col bg-slate-900/90 border border-slate-800 rounded-lg p-3 text-slate-200">
      ...
      <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-800">
        ...
        {onOpenNewUnit && (
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded text-xs transition-colors"
          >
      ...
      {/* Filter Tabs */}
      <div className="flex items-center gap-1 overflow-x-auto pb-1.5 mb-1.5 border-b border-slate-800/80 text-[11px] custom-scroll">
