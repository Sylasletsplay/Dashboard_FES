    ...
    <div className="h-full flex flex-col bg-slate-900/90 border border-slate-800 rounded-lg p-3 text-slate-200">
      ...
      <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-sm tracking-wide uppercase text-slate-100">Datenstrom & Live-Telemetrie</h3>
        </div>
        <span className={`text-xs px-2 py-0.5 rounded font-mono font-semibold flex items-center gap-1.5 ${
          isLive 
      ...
      <div className="grid grid-cols-2 gap-2 flex-1 overflow-y-auto custom-scroll">
        ...
        <div className="bg-slate-950/60 p-2.5 rounded border border-slate-800/80 flex flex-col justify-between">
          ...
          <div className="my-1">
            <span className={`text-base font-bold font-mono ${isLive ? 'text-emerald-400' : 'text-red-400'}`}>
        ...
        <div className="bg-slate-950/60 p-2.5 rounded border border-slate-800/80 flex flex-col justify-between">
          ...
          <div className="my-1 flex items-baseline gap-1">
            <span className={`text-xl font-bold font-mono ${getLatencyColor(telemetry.lastPingMs)}`}>
