    ...
    <div className="h-full flex flex-col bg-slate-900/90 border border-slate-800 rounded-lg p-3 text-slate-200">
      ...
      <div className="relative mb-2">
        ...
        <input
          ...
          className="w-full bg-slate-950 border border-slate-800 rounded pl-7 pr-2 py-1 text-base text-slate-200 placeholder-slate-500 focus:outline-none focus:border-purple-500"
        />
      </div>
        ...
        {filteredEtb.length === 0 ? (
          ...
          filteredEtb.map(entry => (
            ...
            >
              ...
              <div className="text-[16px] text-slate-400 mb-1">
              ...
              {entry.action && (
                <div className="mt-1 pt-1 border-t border-slate-900 text-[16px] text-emerald-400/90 font-mono">
